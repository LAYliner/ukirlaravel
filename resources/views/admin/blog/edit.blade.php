        ...
        <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea name="content" id="content" rows="10" required
                          ...
                          placeholder="Tulis konten artikel di sini...">{{ old('content', $blog->content) }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                @if($blog->thumbnail_path)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $blog->thumbnail_path) }}" alt="Thumbnail" class="w-48 h-auto rounded-md object-cover border border-secondary/30">
                    </div>
                @endif
